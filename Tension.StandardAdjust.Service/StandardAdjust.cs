...
namespace Tension.StandardAdjust
{
    ...
    public partial class StandardAdjust
    {
        ...
        private List<List<int>> _ltPlcRemove = new List<List<int>>();
        ...
        private ModbusInfo _mdiTension = new ModbusInfo();                                 //张力计的Modbus变量
        ...
        public void StandardAdjust_Load()
        {       
            IniDevice();
        }
        ...
        private void IniMdiReadTension()
        {
            _mdiTension.AddrStation = 1;
            _mdiTension.FunCode = FuncCode.ReadHoldingData;
            _mdiTension.AddrData = 0;
            _mdiTension.CntData = 0x02;
            _mdiTension.TypData = TypeData.floatData;
        }

        private void ClrMdiTensionData()
        {
            _mdiTension.Data = null;
        }
        ...
        {
            string fileLog = _rootPath + @"\Log";
            string fileData = _rootPath + @"\Data";
        ...
        private void GetTension(object idx)
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    if (_ltTenAdj[i].StepAdjust >= 10)
                    {
                        ...
                        if(_ltCntTenKeepAliveErr[i] <= 4)
                        {
                            if (_ltMbsSvr[i].Connected())
                            {
                                ...
                                else if (_ltStepAdjust[i] == 400 || _ltStepAdjust[i] == 1100 || _ltStepAdjust[i] == 4000)
                                {
                                    ClrMdiTensionData();
                                    if (_ltMbsSvr[i].ReadData(ref _mdiTension))
                                    {
                                        _ltCntTenKeepAliveErr[i] = 0;
                                        if (_mdiTension.Data != null)
                                        {
                                            _ltCntTenKeepAliveErr[i] = 0;
                                            ten = (float)Math.Round((float)_mdiTension.Data[0], 2);                   //保留两位小数
                                                                                                               //    ten = float.Parse(((float)_mdi.Data[0]).ToString("0.00"));
                                        }
                                        else
                                        {
                                            LogHelper.WriteFile("张力计读张力值为空");
                                            _ltCntTenKeepAliveErr[i]++;
                                        }
                                    ...
                                    {
                                        LogHelper.WriteFile("张力计读张力值不成功");
                                        _ltCntTenKeepAliveErr[i]++;
                                    }
                    ...
                    //调整中,采集张力值,并判断是否稳定
                    if ((_ltStepAdjust[i] == 400 || _ltStepAdjust[i] == 4000) &&
                            ...
                            if(_ltTenAdj[i].StsLeftAdj)
                            {
                                if(_ltDevPar[i][deviceId].LeftK > 0)
                                {
                                    ...
                                    if (cur == 0.0f)
                                    {
                                        ...
                                        //             _ltTenAdj[i].ValWriteCur = _ltDevPar[i][deviceId].LeftK * _ltTenAdj[i].ValTargetTen + _ltDevPar[i][deviceId].LeftA;
                            ...
                            if (_ltTenAdj[i].StepAdjust == 30)
                            {
                                ...
                                if (_ltStable[i])
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        //double dValMin = Math.Abs(_ltDValue[i]) * (1 - a);
                                        //double dValMax = Math.Abs(_ltDValue[i]) * (1 + a);
                                        //double dVal = 0.0f;
                                        //if (_ltDValue[i] > 0)
                                        //    dVal = _ltTenAdj[i].ValAverTen - _ltValPre[i];
                                        //else
                                        //    dVal = _ltValPre[i] - _ltTenAdj[i].ValAverTen;

 
                                        //if ((_ltTenAdj[i].ValAverTen > minTen && _ltTenAdj[i].ValAverTen < maxTen) 
                                        //    ||(dVal > dValMin && dVal < dValMax))
                                        //{
                                        //    _ltCntValNotMatchErr[i] = 0;
                                        //    _ltDValue[i] = _ltTenAdj[i].ValTargetTen - _ltTenAdj[i].ValAverTen;
                                        //    _ltValPre[i] = _ltTenAdj[i].ValAverTen;
                                        ...
                                        //    LogHelper.WriteFile(string.Format("张力计:{0},设备:{1},左/右:{2},丢弃张力3:{3},上一次张力:{4},差值:{5}", _ltTenAdj[i].NameTen, _ltTenAdj[i].NameDev, lr, _ltTenAdj[i].ValAverTen.ToString(), _ltValPre[i], _ltDValue[i]));
                                        //    _ltCntValNotMatchErr[i]++;
                                        //    if (_ltCntValNotMatchErr[i] > 3)
                                        //    {
                                        //        _ltCntValNotMatchErr[i] = 0;
                                        //        _ltValNotMatchErr[i] = true;
                                        //        _ltStepAdjust[i] = 1000;
                                    ...
                                    //        _ltValPre[i] = _ltTenAdj[i].ValAverTen;
                                    //        _ltStable[i] = false;
                                    //        LogHelper.WriteFile(string.Format("张力计:{0},设备:{1},左/右:{2},张力稳定1:Aver:{3},DValue:{4}", _ltTenAdj[i].NameTen, _ltTenAdj[i].NameDev, lr, _ltTenAdj[i].ValAverTen.ToString(), _ltDValue[i]));

                                    //        //第一次稳定张力值达到目标合格值
                                    //        if (Math.Abs(_ltDValue[i]) < _ltDevPar[i][deviceId].ValRange)
                                    //        {
                                    //            _ltTenAdj[i].ValResultTen = _ltTenAdj[i].ValAverTen;
                                    //            _ltTenAdjRest[i].StsLeftAdj = _ltTenAdj[i].StsLeftAdj;
                                    //            _ltTenAdjRest[i].StsRightAdj = _ltTenAdj[i].StsRightAdj;
                                    ...
                                    //            LogHelper.WriteFile(string.Format("张力计:{0},设备:{1},左/右:{2},结果合格1,C:{3},T:{4}", _ltTenAdj[i].NameTen, _ltTenAdj[i].NameDev, lr, _ltTenAdj[i].ValReadCur.ToString(), _ltTenAdj[i].ValAverTen));
                                    ...
                                    //                TimeCreate = DateTime.Now.ToLocalTime(),
                                    //            };
                                    //            LogHelper.WriteFile(string.Format("张力计:{0},设备:{1},左/右:{2},张力调整完成1", _ltTenAdj[i].NameTen, _ltTenAdj[i].NameDev, lr));
                                    //            _ltTenAdjData[i].Add(tai);
                                    ...
                                    //    {
                                    //        _ltStable[i] = false;
                                    //        LogHelper.WriteFile(string.Format("张力计:{0},设备:{1},左/右:{2},丢弃张力1:{3},上一次张力:{4},差值:{5}", _ltTenAdj[i].NameTen, _ltTenAdj[i].NameDev, lr, _ltTenAdj[i].ValAverTen.ToString(), _ltValPre[i], _ltDValue[i]));
                                    //        _ltCntValNotMatchErr[i]++;
                                    //        if (_ltCntValNotMatchErr[i] > 3)
                                    //        {
                                    //            _ltCntValNotMatchErr[i] = 0;
        ...
        private void WriteAdjDataToCsv(TypeInfo Ti, List<TensionAdjInfo> ltTai, string GroupId)
        {
            ...
            FileStream fs = new FileStream(_rootPath + @"\Adjust\" + GroupId + ".csv", FileMode.CreateNew);
        ...
        private void WriteChkDataToCsv(TypeInfo Ti, List<TensionAdjInfo> ltTai, string GroupId)
        {
            ...
            FileStream fs = new FileStream(_rootPath + @"\Check\" + GroupId + ".csv", FileMode.CreateNew);
            fs.Write(buffer, 0, buffer.Length);
            fs.Close();
        }
